...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend-experience/reassurance.css') }}">
</head>
<body>
        ...
        <main>
                ...
                <div class="fe-conversation-layout">
                    <div class="fe-conversation-main">
                        ...
                        <div id="thinkingState" class="fe-message fe-message-ai" hidden>
                            ...
                            <div class="fe-thinking"><span></span><span></span><span></span></div>
                        ...
                        <form id="answerForm" class="fe-question-card" hidden novalidate>
                            <div class="fe-ai-label"><span class="fe-ai-dot"></span>Næste spørgsmål</div>
            ...
            <section id="what-we-help-with" class="fe-info-section">
                ...
                <div class="fe-info-grid">
                    <article><h3>Noget gik galt</h3><p>Du oplevede, at behandling, undersøgelse, diagnose eller medicin måske førte til skade eller forværring.</p></article>
                    <article><h3>Du er usikker</h3><p>Du ved ikke, om det er en klage, en erstatningssag eller noget helt tredje. Det er okay.</p></article>
                    <article><h3>Vi hjælper med næste skridt</h3><p>Systemet spørger stille og roligt ind til det vigtigste, så sagen kan forstås bedre.</p></article>
                </div>
            </section>
            ...
            <section id="how-it-works" class="fe-steps">
                ...
                <div class="fe-step-grid">
                    <article><span>1</span><h3>Fortæl hvad du er bekymret for</h3><p>Start med nogle få sætninger. Du behøver ikke skrive perfekt.</p></article>
                    <article><span>2</span><h3>AI stiller næste spørgsmål</h3><p>Systemet spørger kun om det vigtigste næste skridt.</p></article>
                    <article><span>3</span><h3>Specialist kan gennemgå sagen</h3><p>Hvis sagen virker relevant, kan en person se nærmere på oplysningerne.</p></article>
                </div>
            </section>
            ...
            <section id="faq" class="fe-faq">
                ...
                <details><summary>Hvad kan ErstatningsHjælp hjælpe mig med?</summary><p>Vi hjælper dig med at forklare, hvad der skete, og finde ud af om sagen kan være relevant at få vurderet nærmere.</p></details>
                <details><summary>Skal jeg vide, om jeg har en sag?</summary><p>Nej. Du kan starte med at beskrive din bekymring. Systemet stiller derefter ét spørgsmål ad gangen.</p></details>
                <details><summary>Skal jeg have dokumenter klar?</summary><p>Nej. Du kan starte med din egen beskrivelse. Dokumenter kan være relevante senere.</p></details>
                <details><summary>Er det en endelig vurdering?</summary><p>Nej. Den første oplevelse er en indledende screening og næste-skridt-hjælp.</p></details>
            </section>
        </main>
    </div>
    ...
    <script src="{{ asset('frontend-experience/empathyLayer.js') }}"></script>
</body>
</html>
